...
int main(){
	...
	*/
	...
	while (!mainWindow.getShouldClose()){
		...
		//Almacenar valores en la M temporal
		modelaux = model;
		...
		//ARTICULACIÓN: BRAZO 1 -> BRAZO 2
		// 
		//Descartar la transformación de escala que no quiero heredar
		model = modelaux;
