...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		modelaux = model;
		model = glm::scale(model, glm::vec3(6.0f, 2.0f, 3.0));
		...
		//PATA TRASERA (ARTICULACIÓN 1)
		model = modelaux;
		model = glm::translate(model, glm::vec3(1.0f, 6.2f, -1.0f));
		model = glm::rotate(model, glm::radians(-30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		model = glm::mat4(1.0);
		modelaux = glm::mat4(1.0);
		//PATA DELANTERA DEL FONDO (ARTICULACIÓN 1)
		model = modelaux;
		model = glm::translate(model, glm::vec3(-1.0f, 6.5f, -3.0f));
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//PATA DELANTERA DEL FONDO (ARTICULACIÓN 2)
		model = glm::translate(model, glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::mat4(1.0);
		modelaux = glm::mat4(1.0);
		//PATA TRASERA DEL FONDO (ARTICULACIÓN 1)
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.0f, 6.5f, -3.0f));
		model = glm::rotate(model, glm::radians(30.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		...
		//PATA TRASERA DEL FONDO (ARTICULACIÓN 2)
		model = glm::translate(model, glm::vec3(0.0f, 1.0f, 0.0f));
		modelaux = model;
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//COLA (ARTICULACIÓN 1)
		model = modelaux;
		model = glm::translate(model, glm::vec3(2.0f, 6.5f, -2.0f));
